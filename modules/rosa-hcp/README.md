...
| <a name="output_oidc_provider_arn"></a> [oidc\_provider\_arn](#output\_oidc\_provider\_arn) | The ARN of the OIDC provider associated with the ROSA cluster, used for IAM roles with service account (IRSA) integration. |
